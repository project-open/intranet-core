...
--100000-109999 reserved (10000)
--110000-119999 reserved (10000)
--120000-129999 NeST IT (10000)
--130000-999999 reserved (900000)
...
update im_categories set category_description = 'Unknown project type' 
...
update im_categories set category_description = 'Generic translation project' 
where category = 'Translation Project' and category_type = 'Intranet Project Type';
update im_categories set category_description = 'Translation project with a Trans + Edit static workflow' 
where category = 'Trans + Edit' and category_type = 'Intranet Project Type';
update im_categories set category_description = 'Translation project with a Edit Only static workflow' 
where category = 'Edit Only' and category_type = 'Intranet Project Type';
update im_categories set category_description = 'Translation project with a Trans + Edit + Proof static workflow' 
where category = 'Trans + Edit + Proof' and category_type = 'Intranet Project Type';
update im_categories set category_description = 'Translation project performing Linguistic Validation' 
where category = 'Linguistic Validation' and category_type = 'Intranet Project Type';
update im_categories set category_description = 'Translation project performing Localization activities' 
where category = 'Localization' and category_type = 'Intranet Project Type';
update im_categories set category_description = 'Translation project performing Technological activities' 
where category = 'Technology' and category_type = 'Intranet Project Type';
update im_categories set category_description = 'Translation project with a Trans Only static workflow' 
where category = 'Trans Only' and category_type = 'Intranet Project Type';
update im_categories set category_description = 'Translation project with a Trans + Int. Spotcheck static workflow' 
where category = 'Trans + Int. Spotcheck' and category_type = 'Intranet Project Type';
update im_categories set category_description = 'Translation project with a Proof Only static workflow' 
where category = 'Proof Only' and category_type = 'Intranet Project Type';
update im_categories set category_description = 'Translation project performing Glossary Compilation activities' 
where category = 'Glossary Compilation' and category_type = 'Intranet Project Type';
...
where category = 'Software Maintenance' and category_type = 'Intranet Project Type';
update im_categories set category_description = 'Software development' 
where category = 'Software Development' and category_type = 'Intranet Project Type';
...
update im_categories set category_description = 'Container project for Bug Tracker tasks' 
where category = 'Bug Tracker Container' and category_type = 'Intranet Project Type';
update im_categories set category_description = 'Bug Tracker task' 
where category = 'Bug Tracker Task' and category_type = 'Intranet Project Type';

update im_categories set category_description = 'Represents the items of a software release project' 
where category = 'Software Release Item' and category_type = 'Intranet Project Type';
update im_categories set category_description = 'Represents a software release, consisting of several software release items' 
where category = 'Software Release' and category_type = 'Intranet Project Type';
