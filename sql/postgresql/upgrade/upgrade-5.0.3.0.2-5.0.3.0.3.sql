...
BEGIN
	...
	select	count(*) into v_count from user_tab_columns where lower(table_name) = 'acs_datatypes' and lower(column_name) = 'database_type';
	IF v_count = 0 THEN alter table acs_datatypes add database_type text; END IF; 

	select	count(*) into v_count from user_tab_columns where lower(table_name) = 'acs_datatypes' and lower(column_name) = 'column_size';
	IF v_count = 0 THEN alter table acs_datatypes add column_size text; END IF;

	select	count(*) into v_count from user_tab_columns where lower(table_name) = 'acs_datatypes' and lower(column_name) = 'column_check_expr';
	IF v_count = 0 THEN alter table acs_datatypes add column_check_expr text; END IF;

	select	count(*) into v_count from user_tab_columns where lower(table_name) = 'acs_datatypes' and lower(column_name) = 'column_output_function';
	IF v_count = 0 THEN alter table acs_datatypes add column_output_function text; END IF;
...
alter table acs_attributes drop constraint if exists acs_attributes_datatype_fk; 
...
drop function if exists acs_attribute__create_attribute (varchar,varchar,varchar,varchar,varchar,varchar,varchar,varchar,integer,integer,integer,varchar,boolean,boolean,varchar,varchar,boolean,varchar,varchar,varchar);
...
drop function if exists acs_attribute__create_attribute (varchar,varchar,varchar,varchar,varchar,varchar,varchar,varchar,integer,integer,integer,varchar,boolean);
