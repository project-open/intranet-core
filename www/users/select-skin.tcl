...
ns_log Notice "select-skin.tcl: current_user_id=$current_user_id, skin_id=$skin_id"
...
# Clear cache 
ns_cache flush util_memoize "im_user_skin_helper $user_id"
ns_cache flush util_memoize [list db_string skin_id "select skin_id from users where user_id = $user_id"]
ns_cache flush util_memoize [list db_string sid "select skin_id from users where user_id = $user_id" -default ""]
...
ns_log Notice "select-skin.tcl: before redirecting to return_url=$return_url"
