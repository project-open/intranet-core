...
if ("0" ne $modified_lines) {
    ...
    system("scp -i ~/.ssh/fraber\@shell.sf.net $tar_dir/$tar2 fraber,project-open\@shell.sourceforge.net:/home/frs/project/project-open/project-open/V5.0/nightly_builds/");
